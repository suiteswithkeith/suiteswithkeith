...
if "--legacy" not in sys.argv:
    sys.exit("DEPRECATED: hotel pages are now generated by phase1/ (Astro) from "
             "phase1/src/data/hotels.json — running this would overwrite the new design. "
             "Pass --legacy if you really mean it.")
