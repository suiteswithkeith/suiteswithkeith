...
HOTELS = [
    ...
    dict(
        ...
        credit_label="&euro;100 hotel credit", partner_clause=" with a preferred partnership at Canaves", visited_verb="toured every corner of",
        intro=[
            "Sunday is the entry point to the Canaves portfolio and the most relaxed of the collection in style — eight exclusive suites set in the very heart of Oia's traditional town, with an exceptional three-to-one staff-to-guest ratio.",
            ...
            "But the real play is the buyout. The entire property can be taken over as a single ten-bedroom villa — with no age restrictions once the contract is signed — which turns Sunday into my pick for the best villa in Santorini for a group of friends, a family milestone, or a celebration that wants Oia outside the front door.",
        ],
        stood_out=[
            ("The full-property buyout.", "All of Sunday as one ten-bedroom villa in the middle of Oia — my pick for the best villa in Santorini."),
